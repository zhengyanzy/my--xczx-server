...
public class CourseController extends BaseController implements CourseControllerApi {
    ...
    //当用户拥有course_teachplan_list权限时候方 可访问此方法
    ...
    @GetMapping("/test1")
    public QueryResponseResult<CourseInfo> test1() {
        //获取当前用户信息
        QueryResponseResult<CourseInfo> queryResponseResult = new QueryResponseResult<CourseInfo>(CommonCode.SUCCESS,null);
        return queryResponseResult;
    }
    @GetMapping("/test2")
    public QueryResponseResult<CourseInfo> test2() {
        //获取当前用户信息
        QueryResponseResult<CourseInfo> queryResponseResult = new QueryResponseResult<CourseInfo>(CommonCode.SUCCESS,null);
        return queryResponseResult;
    }
